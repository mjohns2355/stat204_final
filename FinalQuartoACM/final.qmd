...
The Spearman's Rank Correlation shows 95% confidence that Perceived Skill and Final Score are positively correlated, though the correlation is small (less than .3). There is no statistically significant correlation between Likability and Final Score.
